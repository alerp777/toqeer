...
export function ForgotPasswordFlow({
  ...
  if (step === "send-otp") {
    ...
    async function handleSend() {
      setLocalError(null);
      if (!contact.trim()) {
        setLocalError(method === "phone" ? "Enter your phone number" : "Enter your email address");
        return;
      }
      try {
      ...
      <div style={pageStyle}>
        <div style={cardStyle}>
          ...
          <div style={{ marginBottom: 16 }}>
            <label style={labelStyle}>{method === "phone" ? "Phone Number" : "Email Address"}</label>
            <input
      ...
      <div style={pageStyle}>
        <div style={cardStyle}>
          ...
          <div style={{ marginTop: 16 }}>
            <label style={labelStyle}>Or enter backup code</label>
            <input
              type="text"
              value={totpCode}
