...
/* ═══════════════════════════════════════════════════════════════════════════
   JOIN SELECT — Vendor App
   Role selection page: choose Rider or Vendor path.
   Aligned with GuestLanding design language (dark blue theme).
   ═══════════════════════════════════════════════════════════════════════════ */
    ...
    >
        ...
        <div style={{ textAlign: "center", padding: "24px 24px 40px", maxWidth: 560 }}>
          ...
          >
            <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
              <path d="M9 14h24l-3 18H12L9 14z" fill="#060A14" fillOpacity="0.85" />
              <path d="M16 14c0-2.76 2.24-5 5-5s5 2.24 5 5" stroke="#060A14" strokeWidth="2.5" strokeLinecap="round" fill="none" />
              <text x="21" y="27" textAnchor="middle" fontSize="9" fontWeight="800" fill="#060A14" fontFamily="Inter,sans-serif">AJK</text>
            </svg>
          </div>
      ...
      <footer style={{ marginTop: "auto", padding: "40px 24px 24px", textAlign: "center" }}>
        <p style={{ fontSize: 13, color: TEXT_LIGHT, margin: "0 0 8px" }}>
          {C.footerContact} <a href="mailto:support@ajkmart.com" style={{ color: BLUE, textDecoration: "none" }}>support@ajkmart.com</a>
        </p>
