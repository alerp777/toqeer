...
/* ═══════════════════════════════════════════════════════════════════════════
   JOIN SELECT — Rider App
   Role selection page: choose Rider or Vendor path.
   Aligned with GuestLanding design language (dark gold theme).
   ═══════════════════════════════════════════════════════════════════════════ */
    ...
    >
      ...
      <footer style={{ marginTop: "auto", padding: "40px 24px 24px", textAlign: "center" }}>
        <p style={{ fontSize: 13, color: TEXT_LIGHT, margin: "0 0 8px" }}>
          {C.footerContact} <a href="mailto:support@ajkmart.com" style={{ color: GOLD, textDecoration: "none" }}>support@ajkmart.com</a>
        </p>
